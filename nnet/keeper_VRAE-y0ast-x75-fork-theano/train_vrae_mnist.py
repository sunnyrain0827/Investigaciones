...
# encoder = VRAE(hidden_units_encoder, hidden_units_decoder, features, latent_variables, b1, b2,
#                   learning_rate, sigma_init, batch_size):

encoder = vrae.VRAE(HU_decoder, HU_encoder, dimX, dimZ, b1=1., b2=1.,
                    learning_rate=learning_rate, sigma_init=1e-3, batch_size=batch_size)
