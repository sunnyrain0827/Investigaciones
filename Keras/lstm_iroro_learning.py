...
# returns a sequence of vectors of dimension output_dim
model.add(LSTM(output_dim, return_sequences=True, input_length=timesteps, input_dim=inputdata_dim))

# return a single vector of dimension output_dim
